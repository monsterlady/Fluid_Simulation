...
public class ParticleRenderer : MonoBehaviour
{
	...
	public void Init(FluidSimulation2D sim)
	{
		...
		material.SetBuffer("Positions2D", sim.particlePositionsBuffer);
		material.SetBuffer("Velocities", sim.particleVelocitiesBuffer);
		material.SetBuffer("DensityData", sim.fluidDensityBuffer);
